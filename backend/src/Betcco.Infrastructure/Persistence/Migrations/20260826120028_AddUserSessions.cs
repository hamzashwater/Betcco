        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoggedInAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_UserId_RevokedAtUtc_LastActiveAtUtc",
                table: "UserSessions",
                columns: new[] { "UserId", "RevokedAtUtc", "LastActiveAtUtc" });
        }
