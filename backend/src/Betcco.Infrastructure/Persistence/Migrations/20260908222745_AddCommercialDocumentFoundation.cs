...
{
    /// <inheritdoc />
    public partial class AddCommercialDocumentFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerUserId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ...
                    ExternalFiscalReference = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ExternalFiscalStatus = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CreditNotes_Refunds_RefundId",
                        column: x => x.RefundId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemReferenceId = table.Column<Guid>(type: "uuid", nullable: true),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
